...
$category = $categoryTable->findById($id);
?>
<div id="main-container" class="p-3 w-full">
    <nav class="bg-grey-light w-full rounded-md">
        <ol class="list-reset flex">
            ...
            <li class=" text-neutral-500 dark:text-neutral-400"><a>edit-category</a></li>
        </ol>
    </nav>

    <div class="p-3 w-1/5 justify-center align-center mt-5 bg-slate-100">
        <form action="../../actions/admin/category/UpdateCategory.php" method="POST">
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    <div class="mt-5">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="title" id="title" value="<?= $category[0]->title  ?>" placeholder="enter category name" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
