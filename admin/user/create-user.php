...
<div id="main-container" class="p-3 w-full">
    <nav class="bg-grey-light w-full rounded-md">
        <ol class="list-reset flex">
            ...
            <li class=" text-neutral-500 dark:text-neutral-400"><a>create-user</a></li>
        </ol>
    </nav>

    <div class="p-3 w-2/4 flex justify-center mt-5 bg-slate-100">
        <form action="../../actions/admin/user/CreateUser.php" method="POST">
            <div class="space-y-12">
                <div class="pb-12">
                    <h2 class="text-base text-lg font-bold font-mono leading-7 text-gray-900">Personal Information</h2>
                    <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Name*</label>
                            <div class="mt-2">
                                <input type="text" name="name" id="name" placeholder="enter name" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input id="email" name="email" type="email" placeholder="enter email" class="block w-full px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="password" class="block text-sm font-medium leading-6 text-gray-900">Password*</label>
                            <div class="mt-2">
                                <input type="text" name="password" id="password" placeholder="enter password" class="block w-full px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
